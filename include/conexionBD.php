<?php 	
	...
	//Local
	$con=new cConexion("localhost","root","sistemas07","bd_sgtecnoDental",true);//tus datso

	//Red
	//$con=new cConexion("localhost","sgtecno2_admonDental","grup0latis17","sgtecno2_bdDental",true);//tus datso

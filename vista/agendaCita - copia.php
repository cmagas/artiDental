        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-6 div_etiqueta">
                    ...
                    <input type="date" class="form-control" id="txt_fechaCita">
                </div>
                ...
                <div class="col-lg-6 div_etiqueta">
                    ...
                    <input type="time" min="12:00" max="20:00" step="3600" class="form-control" id="txt_HoraCita">
                </div>
                <div class="col-lg-12 div_etiqueta">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-6 div_etiqueta">
                    ...
                    <input type="date" class="form-control" id="txt_fechaCita_modificar">
                </div>
                ...
                <div class="col-lg-6 div_etiqueta">
                    ...
                    <input type="time" min="12:00" max="20:00" step="3600" class="form-control"
                        id="txt_HoraCita_modificar">
                </div>
                <div class="col-lg-12 div_etiqueta">

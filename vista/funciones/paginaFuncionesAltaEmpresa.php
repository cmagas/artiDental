<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES["iptImagen"]["type"]))
    {
        ...
        if($nombre!="")
        {
            ...
            $consulta[$x]="INSERT INTO 2004_empresa(idResponsable,fechaCreacion,razonSocial,
            rfc,url_logo,localidad,estado,municipio,calle,numero,colonia,codPostal,telefono,email,situacion)VALUE('".$idUsuarioSesion."','".$fechaAct."',
            '".$nombre."','".$rfc."','".$ruta."','".$localidad."','".$cveEstado."','".$cveMunicipio."','".$calle."','".$numero."','".$colonia."',
            '".$codPostal."','".$telefono."','".$email."','1')";
            $x++;
